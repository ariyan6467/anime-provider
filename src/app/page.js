...
import EffectCard from "./Component/Sidebar/EffectCard";
...
export default function Home() {
  ...
  useEffect(() => {
    fetch("https://next-anime-server.vercel.app/allanime")
  ...
  return (
    <main className="min-h-screen mx-auto bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <Testimonials></Testimonials>
           ...
           <div className="flex flex-col lg:flex-row md:justify-between    max-w-[1300px] mx-auto h-fit">
                <EffectCard />
                <EffectCard />
                 <EffectCard />
              </div>
          <section className="mx-auto  px-4 pb-16 sm:px-6 lg:px-8">
            <div className="mb-10 flex flex-col gap-4 text-center sm:mb-14">
              ...
              <p className="text-base text-slate-300 sm:text-lg">
                Explore cinematic worlds, discover rare releases, and relive
                your favorite story arcs with our hand-picked selection.
              </p>
            </div>

            <div className="flex flex-col md:flex-row-reverse">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 mx-auto">
                {loading
